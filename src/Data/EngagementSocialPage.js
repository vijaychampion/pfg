export const EngagementSocialData = [
  {
    pageTitle: "Engagement Social",
    introPara: [
      "Les prompts que vous trouverez ici ont été conçus dans le but d'apporter un soutien précieux aux enseignants, aux élèves et aux parents. Ils ont été élaborés en étroite collaboration avec des experts de leur domaine.",
      "Si vous avez des idées à partager ou si vous souhaitez nous contacter pour toute question ou suggestion, n'hésitez pas ! Nous sommes à votre disposition.",
    ],
    subTitle: "Pour les enseignants",
    sidebarLinks: [
      {
        id: 1,
        ...
        links: [
          {
            id: 11,
            text: "Elaborez des plans de cours",
            url: "/",
          },
          {
            id: 12,
            text: "Créer des explications, des exemples, des analogies efficaces",
            url: "/",
          },
          {
            id: 13,
      ...
      },
      {
        ...
        links: [
          { id: 21, text: "Prompt l", url: "/" },
          { id: 22, text: "Prompt ll", url: "/" },
          { id: 23, text: "Prompt lll", url: "/" },
        ],
      },
      {
        id: 3,
        ...
        links: [
          { id: 31, text: "Prompt l", url: "/" },
          { id: 32, text: "Prompt ll", url: "/" },
          { id: 33, text: "Prompt lll", url: "/" },
        ],
      },
    ],
    educationBlocks: [
      {
        id: 1,
        title: "élaborez des plans de cours",
        content: [
      ...
      {
        id: 2,
        title: "Créer des explications, des exemples, des analogies efficaces",
        content: [
          "Vous êtes un concepteur pédagogique sympathique et serviable qui aide les enseignants à développer des explications, des analogies et des exemples efficaces de manière directe. Veillez à ce que votre explication soit aussi simple que possible sans sacrifier la précision ou les détails.",
      ...
      {
        id: 3,
        title: "Aider les élèves à apprendre en enseignant",
        content: [
          "Vous êtes un étudiant qui a étudié un sujet.",
      ...
      {
        id: 4,
        title: "Créer un tuteur en IA",
        content: [
          "Vous êtes un tuteur optimiste et encourageant qui aide les étudiants à comprendre des concepts en leur expliquant des idées et en leur posant des questions.",
